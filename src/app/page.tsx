...
const AdventureMenuScreen = ({
  ...
  const SUPPRESS_QUICK_FILE_PICKER_MS = 8000;
            ...
            {quickScanState === 'processing' ? (
              ...
              <button
                ...
                onPointerDown={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  ignoreQuickFilePickerUntilRef.current = Date.now() + SUPPRESS_QUICK_FILE_PICKER_MS;
                }}
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
...
const RpgButton = ({
  ...
  const pad = compact
    ...
    : small
      ? '12px 10px'
      : '15px 18px';
  const fs = compact ? (small ? 13 : 15) : small ? 14 : 16;
  const gap = compact ? (small ? 7 : 8) : small ? 6 : 9;
  return (
    <button
      onClick={onClick}
      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            <span style={{ fontSize: homeCompact ? 13 : 16 }}>🏡</span>
            <span style={{
              fontSize: homeCompact ? 11 : 14,
              fontWeight: 900,
              color: '#2A5A3A',
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <div style={{
                  ...
                  borderRadius: 999,
                  padding: homeCompact ? '6px 12px' : '10px 20px',
                  boxShadow: `0 2px 0 ${AC.grassDk}77`,
                  textAlign: 'center',
                  minWidth: homeCompact ? 188 : 260,
                }}>
                  <div style={{
                    display: 'flex',
                    alignItems: 'center',
              ...
              <div>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: homeCompact ? 10 : 12, fontWeight: 900, color: AC.textMd }}>
                    {Math.round(tierProgressPct)}%
                  </span>
                  <span style={{ fontSize: homeCompact ? 10 : 12, fontWeight: 900, color: '#2E7B57' }}>
              ...
              <div style={{
                ...
                padding: homeCompact ? '6px 8px' : '8px 12px',
              }}>
        ...
        >
          <div style={{
            transform: 'translateY(px) scale(0.86)',
